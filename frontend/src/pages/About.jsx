  ...
  return (
    <div className="mx-auto max-w-lg space-y-6 px-1 text-center sm:text-left">
      ...
      <p className="text-sm leading-relaxed text-binokio-muted sm:text-base">
        BINOKIO helps you meet real people safely: mutual matches before chat or
        calls, profiles with photos, and tools to block or report. Built for
        phones and tablets as well as desktop.
      </p>
      <ul className="list-inside list-disc space-y-2 text-left text-sm text-white/80 sm:text-base">
        ...
        <li>Real-time chat and optional video calls after a match</li>
